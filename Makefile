...
DEDUCER_SRC:= $(wildcard rosuda/deducer/*.java) $(wildcard rosuda/deducer/models/*.java) $(wildcard rosuda/deducer/menu/*.java) $(wildcard rosuda/deducer/menu/twosample/*.java)  $(wildcard rosuda/deducer/toolkit/*.java) $(wildcard rosuda/deducer/data/*.java)
