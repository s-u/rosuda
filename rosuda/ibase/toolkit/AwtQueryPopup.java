...
{   
	class QPCanvas extends LayerCanvas {
		...
		QPCanvas(PlotComponent ppc, Window wn, SVarSet uvs, String ct, int w, int cid) {
			super(ppc);
    ...
    public AwtQueryPopup(PlotComponent pc, Window ow, SVarSet vs, String ct, int w, int cid)
    {
    ...
    public AwtQueryPopup(PlotComponent pc, Window ow, SVarSet vs, String ct) {
