...
//
  public PSGr(OutputStream o, Graphics g, Dimension appsz) {
    os = new PrintStream(o);
    this.g = g;
    emitProlog();
  ...
  public Rectangle getClipBounds() {Rectangle r = new Rectangle(); return r;}
  public void setClip(int a, int b, int c, int d) {}
  public Shape getClip() {Rectangle r = new Rectangle(); return (Shape) r;}
  ...
  public boolean drawImage(Image i, int a, int b, int c, int d, int e, int f, int g, int h, ImageObserver io) {return true;}
  public boolean drawImage(Image i, int a, int b, int c, int d, int e, int f, int g, int h, Color color, ImageObserver io) {return true;}
