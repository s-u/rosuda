...
public final class TuningDialog extends javax.swing.JDialog {
    ...
    private final DoubleTuneVariablePanel panCost;    
    private final DoubleTuneVariablePanel panNu;    
    private final IntegerTuneVariablePanel panDegree;    
    private final DoubleTuneVariablePanel panCoef0;    
    private final DoubleTuneVariablePanel panGamma;    
    ...
    private void butSavePlotActionPerformed(final java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butSavePlotActionPerformed
        if(plot!=null){
