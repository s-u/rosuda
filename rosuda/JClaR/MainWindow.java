...
public final class MainWindow extends javax.swing.JFrame implements DataClassifierListenerIF, ListSelectionListener {
    ...
    public void datasetsChanged() {
        final List datasets = DatasetManager.getDataVector();
        final ArrayList dataVector = new ArrayList(datasets.size());
        
        for(final ListIterator en=datasets.listIterator(); en.hasNext();){
            final ArrayList v = new ArrayList(3);
            final Data d = (Data)en.next();
            v.add(d.getPath());
    ...
    public void classifiersChanged() {
        final List classifiers = ClassifierManager.getClassifiers();
        final ArrayList dataVector = new ArrayList(classifiers.size());
        
        for(final ListIterator en=classifiers.listIterator(); en.hasNext();){
            final ArrayList v = new ArrayList(2);
            final Classifier c = (Classifier)en.next();
    ...
    private final class NonEditableTableModel extends javax.swing.table.DefaultTableModel {
        ...
        public void setDataVector(final List objects, final List dataVector, final Object[] columnIdentifiers){
            this.objects = objects;
            setDataVector(new Vector(dataVector), convertToVector(columnIdentifiers));
        }
