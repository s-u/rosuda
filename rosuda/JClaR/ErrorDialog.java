...
public final class ErrorDialog extends MessageDialog {
     ...
     */
    //static final long serialVersionUID = 200602271216L;
    ...
    static void show(final Component parent, final String message){
        show(parent,message,DEBUG);
    }
    
    private static void show(Component parent, final String message, final boolean show_hint){
        if(parent==null){
            parent = new Frame();
        }
    ...
    static void show(final Component parent, final RSrvException rse, final String method){
        show(parent, rse, method,DEBUG);
    }
    
    private static void show(Component parent, final RSrvException rse, final String method, final boolean show_hint){
        if(parent==null){
            parent = new Frame();
        }
