...
/**
 * RModel - This is a simple java-representation of an object from R providing
...
public class RObject {
	 ...
	 *            type of object
	 * @param parent
	 *            parent object, e.g. if it's an inner vector of a data.frame
	 * @param b
	 *            is there are real R-name or should we set a number instead
	 */
	...
	/**
	 * Check wether the object is atomar or not, atomar objects are: function,
	 * integer, numeric, character, logical, factor, environment (because they
	 * are not supported).
	 * 
	 * @return true if it's atomar, false if it is not
	 */
	public boolean isAtomar() {
		if (type.indexOf("function") >= 0 || type.indexOf("integer") >= 0
	...
	/**
	 * Check if editing this object is supported, types which are supported are:
	 * numeric, integer, factor, character, data.frame, matrix, list.
	 * 
	 * @return true if editing is allowed, false if not
	 */
	public boolean isEditable() {
		if (type.indexOf("numeric") >= 0 || type.indexOf("integer") >= 0
	...
	/**
	 * Set information about object, depends on object: data.frame -> dimension,
	 * function -> arguments, factor -> levels, ....
	 * 
	 * @param s
	 *            information depending on object
	 */
