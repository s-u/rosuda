...
public class IndexStream extends Object {
	...
	public void readStream() {
		try {
			...
			// according to JDK 1.1.3 docs, now use BufferedReader. Here the
			// docs:
			//
 ...
 * Revision 1.3 2005/01/15 13:12:27 helbigm fully
 * documented
 * 
 * Revision 1.2 2004/07/31 21:31:14 helbigm renamed some files and added a lot
 * of new ones
 * 
 * Revision 1.1 2004/04/24 21:41:48 helbigm ** empty log message ***
 * 
 * Revision 1.2 2004/04/24 21:05:18 helbigm put everything to JGR
 * 
 * Revision 1.1 2004/03/07 12:10:27 helbigm ** empty log message ***
 * 
 * Revision 1.4 2002/05/05 22:34:52 pd .subset/.subset2, perfomace tweak in
 * [[.data.frame
 * 
 * Revision 1.3 1999/08/10 09:56:03 ripley change FSF address in copyrights add
 * some copyrights in src/gnome and elsewhere
 * 
 * Revision 1.2 1999/03/04 17:15:18 leisch various bugfixes
 * 
 * Revision 1.1.4.1 1999/03/02 15:19:55 leisch search used only kewords, no
 * titles
 * 
 * Revision 1.2 1998/05/15 22:08:57 baier handle include
 * 
 * Revision 1.1 1998/05/10 02:43:37 baier Initial revision
 * 
 * 
 * ==============================================================================
 */
