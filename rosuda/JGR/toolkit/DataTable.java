...
public class DataTable extends TJFrame implements ActionListener, MouseListener, KeyListener {
	...
	/**
	 * add a column (we allow numerical variables or strings), we add this
	 * column after the selected one, if none is selected we add at the end
	 */
	...
	/**
	 * add a row, we add rows after the selected one, if none is selected we add
	 * at the bottom
	 */
	private void addRow() {
		modified = true;
	 ...
	 * 
	 * @param x
	 *            x-coordinate we begin to search from this index
	 * @param y
	 *            y-coordinate we begin to search from this index
	 */
