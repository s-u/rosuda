...
public class Editor extends iFrame implements ActionListener, KeyListener {
	...
	public Editor(String file) {
		...
		String[] Menu = { "+", "File", "@NNew", "new", "@OOpen", "open",
				"#Open Recent", "", "@SSave", "save", "!SSave as", "saveas",
				"-", "@PPrint", "print", "~File.Basic.End", "~Editor", "+",
				"Tools", "Increase Font Size", "fontBigger",
				"Decrease Font Size", "fontSmaller", "~Window", "~Help", /*
																			 * "R
																			 * Help",
																			 * "help",
																			 */
		...
		JMenu rm = recentMenu = (JMenu) iMenu.getItemByLabel(this,
				"Open Recent");
		if (rm != null) {
			if (recentOpen == null)
