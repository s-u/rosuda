...
public class PngEncoder extends Object {
    ...
    /** Added by SU: static method to create a PNG file from an encoder */
    public static boolean savePNG(File f, PngEncoder png)
    {
        byte[] pngbytes;
        try {
            ...
            if (Global.DEBUG>0)
                System.out.println("PngEncoder: I/O error : "+e);
        }
        return false;
    }       
}
